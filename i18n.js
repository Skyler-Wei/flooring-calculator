...
const T = {
    zh: {
        ...
        pallet_estimated_match: '数据表无对应长宽，已按纸箱摆放和常用标准尺寸估算：{length} × {width} mm，请确认。',
        pallet_no_match: '数据表中暂无对应长宽，保留当前托盘尺寸。',
        floor_dimensions_reversed: '提醒：地板长小于地板宽，已按旋转方向检查托盘匹配。',
        ...
        loaded_search_note: '优先尽量装下计划托数，同托数时优先空间利用率高的方案。同规格最多叠三托，需满足现场叠放条件。复杂混排不保证全局最优。',
        mixed_spec: '地板规格',
        mixed_pallet: '托盘尺寸',
        mixed_quantity: '计划托数',
        ...
        layout_hint: '每托盒数、层数和层内摆法一致，只装整层。最多叠三托，上托与下托对齐并完整支撑。',
    ...
    en: {
        ...
        pallet_estimated_match: 'No matching flooring dimensions; estimated from box fit and common standard sizes: {length} × {width} mm. Please confirm.',
        pallet_no_match: 'No matching dimensions in the data table; current pallet size is retained.',
        floor_dimensions_reversed: 'Reminder: tile length is less than tile width; pallet matching checked with rotation.',
        ...
        loaded_search_note: 'Maximizes loaded pallet count, then space utilization. Identical pallets may stack up to three high where handling and load-bearing conditions permit. Complex layouts are not guaranteed globally optimal.',
        ...
        layout_hint: 'Identical box counts, full layers and layer layouts on every pallet. At most three pallets high, aligned and fully supported.',
    ...
    vi: {
        ...
        pallet_estimated_match: 'Không có kích thước tương ứng; đã ước tính theo cách xếp hộp và kích thước pallet tiêu chuẩn: {length} × {width} mm. Vui lòng xác nhận.',
        pallet_no_match: 'Không có kích thước tương ứng trong bảng; giữ nguyên kích thước pallet hiện tại.',
        floor_dimensions_reversed: 'Lưu ý: chiều dài tấm sàn nhỏ hơn chiều rộng; đã kiểm tra khớp pallet theo hướng xoay.',
        ...
        loaded_search_note: 'Ưu tiên xếp nhiều pallet nhất, sau đó tối đa tỷ lệ sử dụng không gian. Pallet cùng loại có thể chồng tối đa ba tầng nếu điều kiện cho phép. Không đảm bảo tối ưu toàn cục.',
        ...
        layout_hint: 'Mọi pallet có cùng số hộp, số lớp đầy đủ và cách xếp mỗi lớp. Chồng tối đa ba pallet, thẳng hàng và được đỡ hoàn toàn.',
